(() => {
  ...
  const app = {
    ...
    buildUI() {
        ...
        <div class="ads-wrap">
          ...
          <section class="ads-panel">
            ...
            <div class="ads-body">
              ...
              <div class="ads-note">
                最终版说明：支持拖动标题栏、双击标题栏折叠/展开、位置与折叠状态持久化、重置位置。
                全页 Markdown 自动队列保留 prompt/confirm/alert fallback 拦截与纯文本兜底机制。
              </div>
            </div>
          </section>
        </div>
      ...
      this.refs.titlebar.addEventListener("dblclick", (e) => {
        if (e.target.closest("button")) return;
        this.toggleCollapse();
      });
      ...
      this.refs.titlebar.addEventListener("pointercancel", (e) => this.onTitlebarPointerUp(e));
